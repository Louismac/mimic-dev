  ...
  function normalizeCourse({ course }) {
    return {
      ...
      attributes: {
        ...
        units: course.units.map(unit => normalizeUnit({ course, unit })),
...
;define('ember-share-db/components/portable-text-contents', ['exports'], function (exports) {
  'use strict';
...
;define('ember-share-db/components/portable-text-span', ['exports'], function (exports) {
  'use strict';
...
;define('ember-share-db/controllers/code-editor', ['exports', 'sharedb/lib/client', 'reconnecting-websocket', 'ember-share-db/config/environment'], function (exports, _client, _reconnectingWebsocket, _environment) {
  ...
  exports.default = Ember.Controller.extend({
    ...
    //Updates the code in the main window
      ...
      if (e.origin === _environment.default.localOrigin && drag && !Ember.isEmpty(e.data)) {
        if (e.data[0].substring(0, 2) == "p_") {
          ...
          for (let i = 1; i < e.data.length; i++) {
            let text = e.data[i];
            //Dont show maximilian error, this comes from the weird way we
            //put code in script tags, its not a reall error
            if (!text.includes("ReferenceError: Maximilian is not defined") && !text.includes("ReferenceError: Input is not defined")) {
              self.get('cs').logToScreen(text);
            }
          }
...
;define("ember-share-db/controllers/course", ["exports", "ember-share-db/config/environment"], function (exports, _environment) {
  "use strict";
  ...
  exports.default = Ember.Controller.extend({
    ...
    examples: Ember.computed(() => {
      return [{ title: "Mouse Input", docs: [
        ...
        //MFCCs
        { docid: "dc336824-4f8f-142d-2d33-bcbb185c6ab6", desc: "maximilian.js to get MFCCs, a great timbral feature for classifying audio." },
        //Audio features
        ...
        //MoveNet
        { docid: "8a60a7b7-6277-2b4f-8aae-389f7b49ca1c", desc: "Tensorflow's MoveNet Model. This is Tensorflow JS's preferred post model and uses a pretrained model to get 17 skeleton points" },
        //BodyPix
        ...
        //Hands
        { docid: "d1c15d10-1071-a6a2-ac9c-82447150d771", desc: "Uses Tensorflow to get many points on the hand" },
        //Facemesh
        { docid: "8aa114c7-3e87-5ef6-e81e-151c5cd9a38a", desc: "Uses Tensorflow model to get a mesh (many points!) of a face. Works for multiple faces at once" },
        //Emotions
        ...
        //BLE Device
        { docid: "bba8baa2-63bc-45d7-bd1b-38bc2f114268", desc: "Connect a BLE device using WebBLE. Only works in Chrome" },
        //Microbit
        ...
        //OSC
        { docid: "10fe5752-913e-71d8-3fd4-0ec0f0b9f4f3", desc: "Record values sent over OSC (via websockets) into a dataset" }] }, { title: "Text", docs: [
        //Sentiment
...
;define("ember-share-db/models/course-unit", ["exports", "ember-data"], function (exports, _emberData) {
  "use strict";
...
;define("ember-share-db/models/course", ["exports", "ember-data"], function (exports, _emberData) {
  "use strict";
  ...
  exports.default = _emberData.default.Model.extend({
    ...
    summary: attr(),
    prerequisites: attr(),
    "is-published": attr("boolean"),
    "published-at": attr("string")
  });
});
...
;define("ember-share-db/routes/course", ["exports"], function (exports) {
  "use strict";
...
;define('ember-share-db/routes/tfjs', ['exports'], function (exports) {
  'use strict';
    ...
    */
    ...
    getScripts(source) {
      ...
      if (scripts.length > 0) {
        ...
        scripts[0].preamble = scripts[0].preamble + "<script>window.onerror = function(error, url, line) {parent.postMessage([\"console\", \"❌ -- [ERROR] -- ❌ -- ⚠️ \" + error], \"*\")};var cl = console.log;console.log = function () {var msg = [...arguments].join();parent.postMessage([\"console\", msg], \"*\");  }  </script>";
...
;define("ember-share-db/services/courses", ["exports", "ember-share-db/config/environment"], function (exports, _environment) {
  "use strict";
  ...
  exports.default = Ember.Service.extend({
    guides: Ember.computed(() => {
      return [{
        ...
        guides: [{
          id: "supervised-ml",
          name: "Basic Supervised Learning",
          desc: "Learn about supervised machine learning and how you can build interactive music systems in the browser using just examples",
          author: "Louis McCallum"
        }, {
          id: "learner",
          name: "Building Mappings by Example with Learner.js",
          desc: "Learner.js provides an interface that allows you to easily record in examples of input and output pairings. You can then train a model to respond with new outputs when you provide new inputs. We take care of all the storage, threading and GUI needs and all you have to do is pick what you want to control!",
          author: "Louis McCallum"
        }, {
          id: "kadenze",
          name: "Machine Learning for Musicians and Artists alongside Kadenze",
          desc: "Translating Wekinator based exercises to the MIMIC platform from Rebecca Fiebrink's excellent Kadenze course",
          author: "Louis McCallum"
        }, {
          id: "RAPIDMIX",
          name: "Using RapidLib.js for Machine Learning",
          desc: " This page provides a minimal guide on how to use the RapidLib, showing how to use simple machine learning objects in five steps with two simple examples of applied Machine Learning tasks.",
          author: "Franciso Bernardo"
        }]
      }, {
        title: "Making Music",
        guides: [{
          id: "maxi-instrument",
          name: "AudioWorklet Backed Synths and Samplers with MaxiInstuments.js",
          desc: "MaxiInstruments is a class of simple synths and samplers that are designed to so that their parameters can be easily controlled using the Learner.js library. They are AudioWorklets backed so do not get interrupted by beefy feature extractors one might use an an input or the running of a model to do the mapping. ",
          author: "Louis McCallum"
        }, {
          id: "maximJS",
          name: "Making Music in the Browser with maxmilian.js",
          desc: "Maximilian.js is a javascript library for sound analysis and synthesis. This document is a reference to the maxmilian.js API, illustrated with examples.",
          author: "Chris Kiefer and Louis McCallum"
        }, {
          id: "evolib",
          name: "Evolutionary Sound Synthesis with Evolib.js",
          desc: "How about using a machine intelligence technique to help us to program a modular synthesizer? In this guide, we'll show you how",
        ...
        guides: [{
          id: "mmll",
          name: "Musical Machine Listening with MMLL.js",
          desc: "Machine listening is the attempt to make computers hear sound intelligently. The interest of the MIMIC project is in musical machine listening, that is, the computer understanding of musical audio signals, and the Musical Machine Listening Library introduced here (subsequently MMLL) is a javascript library to do just that, in the web browser. ",
          author: "Nick Collins"
        }]
      }, {
        title: "The Platform",
        guides: [{
          id: "recording",
          name: "In-Built Recording in MIMIC",
          desc: "How to record yourself in the MIMIC platform (and WTF are nodes?).",
          author: "Louis McCallum"
        }, {
          id: "colab",
          name: "Collaborative Coding on MIMIC",
          desc: "MIMIC allows for both collaborative and remote coding (great for teaching!). Learn how",
          author: "Louis McCallum"
        }]
      }];
    })
    ...
    outputs() {
      return {
        maxiSynthParamMapped: {
          headers: `  <script src = "https://mimicproject.com/libs/maxiInstruments.v.0.7.2.js"></script>
`,
...
`,
    ...
    */
    ...
    `,
        ...
        midiCC: {
          headers: `  <script src="https://mimicproject.com/libs/MIMICMIDI.js"></script>
`,
...
`,
    ...
    models() {
      return {
        classification: {
          headers: `  <script src = "https://mimicproject.com/libs/learner.v.0.5.js"></script>
`,
...
`,
    ...
    inputs() {
      return {
        mouse: {
          headers: ``,
          html: `  <div style = "width:400px;height:200px;background-color:blue;" id = "input"></div>
`,
...
`,
        ...
        mfccs: {
          headers: `  <script src = "https://mimicproject.com/libs/maximilian.v.0.1.js"></script>
`,
...
`,
        ...
        audioFeatures: {
          headers: `  <script src = "https://mimicproject.com/libs/MMLL.js"></script>
`,
...
;define("ember-share-db/templates/components/about-description", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "B1aYdsGy", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"id\",\"about-overlay-title\"],[9],[0,\"\\n  \"],[7,\"p\"],[11,\"id\",\"about-overlay-title-text\"],[9],[0,\"\\n    Make Music and Art\\n    \"],[7,\"br\"],[9],[10],[0,\"with Machine Intelligence\\n  \"],[10],[0,\"\\n\"],[10],[0,\"\\n\"],[4,\"if\",[[25,[\"mediaQueries\",\"isXs\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\"],[9],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"id\",\"about-overlay-desc\"],[9],[0,\"\\n    \"],[7,\"p\"],[11,\"id\",\"about-overlay-desc-text\"],[9],[0,\"\\n      The mimic project offers a way to make new kinds of music, sound and\\n      creative arts experiences using machine learning, machine listening and\\n      artificial intelligence.\\n    \"],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"id\",\"about-overlay-buttons-container\"],[9],[0,\"\\n      \"],[7,\"div\"],[11,\"id\",\"getting-started-container\"],[11,\"class\",\"about-overlay-button-container\"],[9],[0,\"\\n        \"],[7,\"a\"],[11,\"id\",\"getting-started-link\"],[11,\"class\",\"about-overlay-button-link\"],[12,\"href\",[23,\"docURL\"]],[9],[0,\" Getting Started → \"],[10],[0,\"\\n      \"],[10],[0,\"\\n      \"],[7,\"div\"],[11,\"class\",\"about-overlay-button-container\"],[9],[0,\"\\n        \"],[7,\"a\"],[11,\"class\",\"about-overlay-button-link\"],[11,\"href\",\"guides/root\"],[9],[0,\" Guides → \"],[10],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n  \"],[10],[0,\"\\n\"]],\"parameters\":[]}]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/about-description.hbs" } });
});
...
;define("ember-share-db/templates/components/collapsable-unit-list", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "L4ORqE+0", "block": "{\"symbols\":[\"unit\"],\"statements\":[[7,\"a\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onClick\"],null]],[9],[0,\"\\n  \"],[4,\"if\",[[24,0,[\"collapsedClassname\"]]],null,{\"statements\":[[0,\"Show units\"]],\"parameters\":[]},{\"statements\":[[0,\"Hide units\"]],\"parameters\":[]}],[0,\"\\n\"],[10],[0,\"\\n\\n\"],[7,\"div\"],[11,\"id\",\"collapsable-units\"],[12,\"class\",[30,[[24,0,[\"collapsedClassname\"]]]]],[9],[0,\"\\n  \"],[7,\"ol\"],[9],[0,\"\\n\"],[4,\"each\",[[25,[\"units\"]]],null,{\"statements\":[[0,\"      \"],[7,\"li\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onClick\"],null]],[12,\"class\",[30,[[29,\"if\",[[29,\"isEqual\",[[24,1,[\"id\"]],[24,0,[\"currUnitId\"]]],null],\"active\"],null]]]],[9],[4,\"link-to\",[\"course.course-unit\",[24,1,[\"id\"]]],null,{\"statements\":[[1,[24,1,[\"title\"]],false]],\"parameters\":[]},null],[10],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"],[10],[0,\"\\n\"],[10]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/collapsable-unit-list.hbs" } });
});
...
;define("ember-share-db/templates/components/guide-tile", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "LbIFcDGr", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"role\",\"button\"],[11,\"tabIndex\",\"0\"],[11,\"class\",\"example-tile-container-outer col-xs-12 col-sm-12\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onClick\"],null]],[12,\"onmouseover\",[29,\"action\",[[24,0,[]],\"onover\"],null]],[12,\"onmouseout\",[29,\"action\",[[24,0,[]],\"onout\"],null]],[12,\"onkeypress\",[29,\"action\",[[24,0,[]],\"onClick\"],null]],[9],[0,\"\\n  \"],[7,\"div\"],[11,\"class\",\"example-tile-container\"],[12,\"id\",[23,\"colourId\"]],[9],[0,\"\\n    \"],[7,\"table\"],[9],[0,\"\\n      \"],[7,\"caption\"],[11,\"style\",\"padding:0px;color:inherit;\"],[9],[7,\"p\"],[11,\"class\",\"example-tile-title\"],[12,\"id\",[23,\"colourId\"]],[9],[1,[29,\"if\",[[25,[\"name\"]],[25,[\"name\"]],[25,[\"guide\",\"title\"]]],null],false],[10],[10],[0,\"\\n      \"],[7,\"td\"],[9],[0,\"\\n        \"],[7,\"div\"],[11,\"class\",\"guide-author-container\"],[12,\"id\",[23,\"colourId\"]],[9],[0,\"\\n          by\\n          \"],[1,[23,\"author\"],false],[0,\"\\n        \"],[10],[0,\"\\n        \"],[7,\"div\"],[11,\"class\",\"example-color\"],[12,\"id\",[23,\"colourId\"]],[9],[0,\"\\n          \"],[1,[29,\"shape-cell\",null,[[\"isSelected\",\"colourId\"],[[25,[\"isSelected\"]],[25,[\"colourId\"]]]]],false],[0,\"\\n        \"],[10],[0,\"\\n      \"],[10],[0,\"\\n      \"],[7,\"td\"],[9],[0,\"\\n        \"],[7,\"p\"],[11,\"class\",\"guide-desc-text\"],[9],[1,[29,\"if\",[[25,[\"description\"]],[25,[\"description\"]],[25,[\"guide\",\"description\"]]],null],false],[10],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n  \"],[10],[0,\"\\n\"],[10],[0,\"\\n\"],[1,[29,\"log\",[[25,[\"guide\"]]],null],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/guide-tile.hbs" } });
});
...
;define("ember-share-db/templates/components/main-navigation", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "2lePKfAL", "block": "{\"symbols\":[\"nav\",\"dd\",\"ddm\",\"dd\",\"ddm\",\"doc\",\"dd\",\"ddm\",\"dd\",\"ddm\"],\"statements\":[[7,\"div\"],[11,\"id\",\"mimic-navbar\"],[11,\"class\",\"limited-width-container\"],[9],[0,\"\\n  \"],[7,\"img\"],[12,\"src\",[23,\"logoURL\"]],[11,\"alt\",\"main logo\"],[11,\"id\",\"main-logo\"],[9],[10],[0,\"\\n  \"],[7,\"div\"],[11,\"id\",\"minim-navbar-button-container\"],[9],[0,\"\\n\"],[4,\"bs-nav\",null,[[\"type\"],[\"pills\"]],{\"statements\":[[4,\"if\",[[25,[\"mediaQueries\",\"isBurger\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L6:C11) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,9,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L7:C13) \"],null]],[[\"class\"],[\"nav-dropdown burger-btn\"]],{\"statements\":[[0,\"            ≡\\n            \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,9,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L10:C13) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L11:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/getting-started/beginner\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"getting started\"],[3,\"action\",[[24,0,[]],\"gettingStarted\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L18:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/guides/root\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"guides\"],[3,\"action\",[[24,0,[]],\"guides\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L25:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/people\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"people\"],[3,\"action\",[[24,0,[]],\"people\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L32:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/inputs\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"inputs\"],[3,\"action\",[[24,0,[]],\"inputs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L39:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/outputs\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"outputs\"],[3,\"action\",[[24,0,[]],\"outputs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L46:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/d/ /views/0\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"projects\"],[3,\"action\",[[24,0,[]],\"docs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L53:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/examples\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"examples\"],[3,\"action\",[[24,0,[]],\"examples\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L61:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/d/\",[25,[\"sessionAccount\",\"currentUserName\"]],\"/views/0\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"my projects\"],[3,\"action\",[[24,0,[]],\"docs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,10,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L74:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/about\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"about\"],[3,\"action\",[[24,0,[]],\"about\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[10]},null]],\"parameters\":[9]},null]],\"parameters\":[]},{\"statements\":[[0,\"\\n        \"],[7,\"li\"],[9],[0,\"\\n          \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/getting-started/beginner\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"getting started\"],[3,\"action\",[[24,0,[]],\"gettingStarted\"]],[10],[0,\"\\n        \"],[10],[0,\"\\n        \"],[7,\"li\"],[9],[0,\"\\n          \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/guides/root\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"guides\"],[3,\"action\",[[24,0,[]],\"guides\"]],[10],[0,\"\\n        \"],[10],[0,\"\\n\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L100:C11) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,7,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L101:C13) \"],null]],[[\"class\"],[\"nav-dropdown\"]],{\"statements\":[[0,\"            explore\\n            \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,7,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L104:C13) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,8,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L105:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/examples/root\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"examples\"],[3,\"action\",[[24,0,[]],\"examples\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,8,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L112:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/inputs\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"inputs\"],[3,\"action\",[[24,0,[]],\"inputs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,8,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L119:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/outputs\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"outputs\"],[3,\"action\",[[24,0,[]],\"outputs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,8,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L126:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/d/ /views/0\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"projects\"],[3,\"action\",[[24,0,[]],\"docs\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[8]},null]],\"parameters\":[7]},null],[0,\"\\n\"],[4,\"if\",[[25,[\"session\",\"isAuthenticated\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L137:C13) \"],null]],null,{\"statements\":[[0,\"            \"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,4,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L138:C15) \"],null]],[[\"class\"],[\"nav-dropdown\"]],{\"statements\":[[0,\"my projects\\n              \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,4,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L140:C15) \"],null]],null,{\"statements\":[[4,\"each\",[[25,[\"ownedDocuments\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,5,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L142:C19) \"],null]],null,{\"statements\":[[0,\"                  \"],[7,\"a\"],[11,\"class\",\"dropdown-item\"],[9],[1,[24,6,[\"name\"]],false],[3,\"action\",[[24,0,[]],\"openDoc\",[24,6,[\"id\"]]]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[6]},null],[0,\"              \"],[7,\"a\"],[11,\"id\",\"create-doc-dropdown-item\"],[11,\"class\",\"dropdown-item\"],[9],[0,\"...\"],[3,\"action\",[[24,0,[]],\"allDocs\"]],[10],[0,\"\\n              \"],[7,\"a\"],[11,\"id\",\"create-doc-dropdown-item\"],[11,\"class\",\"dropdown-item\"],[9],[0,\"+\"],[3,\"action\",[[24,0,[]],\"createDoc\"]],[10],[0,\"\\n\"]],\"parameters\":[5]},null]],\"parameters\":[4]},null]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L163:C11) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,2,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L164:C13) \"],null]],[[\"class\"],[\"nav-dropdown\"]],{\"statements\":[[0,\"            about\\n            \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,2,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L168:C13) \"],null]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,3,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L169:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/onAbout\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"about\"],[3,\"action\",[[24,0,[]],\"about\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,3,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/main-navigation.hbs' @ L176:C15) \"],null]],null,{\"statements\":[[0,\"              \"],[7,\"a\"],[12,\"href\",[29,\"concat\",[[25,[\"url\"]],\"/people\"],null]],[11,\"class\",\"nav-button dropdown-item\"],[9],[0,\"people\"],[3,\"action\",[[24,0,[]],\"people\"]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[3]},null]],\"parameters\":[2]},null]],\"parameters\":[]}]],\"parameters\":[1]},null],[4,\"if\",[[25,[\"session\",\"isAuthenticated\"]]],null,{\"statements\":[[0,\"      \"],[7,\"div\"],[11,\"id\",\"login-container\"],[9],[0,\"\\n        \"],[7,\"div\"],[11,\"style\",\"float:right;\"],[11,\"class\",\"tooltip\"],[9],[0,\"\\n          \"],[7,\"a\"],[11,\"id\",\"login-button\"],[11,\"class\",\"navbar-btn navbar-right pull-right\"],[9],[0,\"log out\"],[3,\"action\",[[24,0,[]],\"logout\"]],[10],[0,\"\\n          \"],[7,\"span\"],[11,\"class\",\"tooltiptext\"],[9],[0,\"logged in as\\n            \"],[1,[25,[\"sessionAccount\",\"currentUserName\"]],false],[10],[0,\"\\n        \"],[10],[0,\"\\n      \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"      \"],[7,\"div\"],[11,\"id\",\"login-container\"],[9],[0,\"\\n        \"],[7,\"a\"],[11,\"id\",\"login-button\"],[11,\"class\",\"navbar-right\"],[9],[0,\"sign up/log\\n          in\"],[3,\"action\",[[24,0,[]],\"login\"]],[10],[0,\"\\n      \"],[10],[0,\"\\n\"]],\"parameters\":[]}],[0,\"  \"],[10],[0,\"\\n\"],[10]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/main-navigation.hbs" } });
});
...
;define("ember-share-db/templates/components/portable-text-contents", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "fO5h4bD/", "block": "{\"symbols\":[\"content\",\"child\",\"child\",\"child\"],\"statements\":[[4,\"if\",[[25,[\"contents\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"class\",\"portable-text-contents\"],[9],[0,\"\\n\"],[4,\"each\",[[29,\"processContents\",[[25,[\"contents\"]]],null]],null,{\"statements\":[[4,\"if\",[[29,\"isEqual\",[[24,1,[\"_type\"]],\"block\"],null]],null,{\"statements\":[[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"style\"]],\"h1\"],null]],null,{\"statements\":[[0,\"          \"],[7,\"h1\"],[9],[0,\"\\n\"],[4,\"each\",[[24,1,[\"children\"]]],null,{\"statements\":[[0,\"              \"],[1,[24,4,[\"text\"]],false],[0,\"\\n\"]],\"parameters\":[4]},null],[0,\"          \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"style\"]],\"h2\"],null]],null,{\"statements\":[[0,\"          \"],[7,\"h2\"],[9],[0,\"\\n\"],[4,\"each\",[[24,1,[\"children\"]]],null,{\"statements\":[[0,\"              \"],[1,[24,3,[\"text\"]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"          \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"style\"]],\"h3\"],null]],null,{\"statements\":[[0,\"          \"],[7,\"h3\"],[9],[0,\"\\n\"],[4,\"each\",[[24,1,[\"children\"]]],null,{\"statements\":[[0,\"              \"],[1,[24,2,[\"text\"]],false],[0,\"\\n\"]],\"parameters\":[2]},null],[0,\"          \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"style\"]],\"normal\"],null]],null,{\"statements\":[[4,\"if\",[[29,\"isEqual\",[[24,1,[\"listItem\"]],\"bullet\"],null]],null,{\"statements\":[[0,\"            \"],[7,\"ul\"],[9],[0,\"\\n              \"],[7,\"li\"],[9],[0,\"\\n                \"],[5,\"portable-text-span\",[],[[\"@children\"],[[24,1,[\"children\"]]]]],[0,\"\\n              \"],[10],[0,\"\\n            \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"            \"],[7,\"p\"],[12,\"class\",[30,[\"tutorial-text \",[29,\"join\",[[24,1,[\"marks\"]],\" \"],null]]]],[9],[0,\"\\n              \"],[5,\"portable-text-span\",[],[[\"@children\"],[[24,1,[\"children\"]]]]],[0,\"\\n\"],[0,\"            \"],[10],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},null]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"_type\"]],\"mimicDoc\"],null]],null,{\"statements\":[[0,\"        \"],[5,\"portable-text-mimic-block\",[],[[\"@docId\",\"@isHiddenSolution\"],[[30,[[24,1,[\"id\"]]]],[30,[[24,1,[\"isHiddenSolution\"]]]]]]],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"if\",[[29,\"isEqual\",[[24,1,[\"_type\"]],\"videoEmbed\"],null]],null,{\"statements\":[[0,\"        \"],[5,\"video-embed\",[],[[\"@title\",\"@videoId\",\"@videoSource\",\"@description\",\"@text_contents\"],[[30,[[24,1,[\"title\"]]]],[30,[[24,1,[\"videoId\"]]]],[30,[[24,1,[\"videoSource\"]]]],[30,[[24,1,[\"description\"]]]],[24,1,[\"text_contents\"]]]]],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"]],\"parameters\":[1]},null],[0,\"  \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n\"],[1,[29,\"log\",[[25,[\"content\"]]],null],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/portable-text-contents.hbs" } });
});
;define("ember-share-db/templates/components/portable-text-mimic-block", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "2Wv9DWO0", "block": "{\"symbols\":[],\"statements\":[[4,\"if\",[[25,[\"docId\"]]],null,{\"statements\":[[4,\"if\",[[25,[\"isHiddenSolution\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[9],[0,\"\\n      \"],[4,\"if\",[[24,0,[\"isRevealed\"]]],null,{\"statements\":[],\"parameters\":[]},{\"statements\":[[0,\"\\n        \"],[7,\"a\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onClickReveal\"],null]],[11,\"class\",\"mimic-block-reveal-solution-button embedded-link\"],[9],[0,\"\\n          Reveal solution\\n        \"],[10]],\"parameters\":[]}],[0,\"\\n      \"],[7,\"div\"],[12,\"class\",[30,[\"mimic-block-container \",[29,\"if\",[[29,\"not\",[[24,0,[\"isRevealed\"]]],null],\"hidden\"],null]]]],[9],[0,\"\\n        \"],[5,\"embedded-project\",[],[[\"@height\",\"@manualLoad\",\"@docId\"],[\"700px\",false,[30,[[23,\"docId\"]]]]]],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[5,\"embedded-project\",[],[[\"@height\",\"@manualLoad\",\"@docId\"],[\"700px\",false,[30,[[23,\"docId\"]]]]]],[0,\"\\n\"]],\"parameters\":[]}]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/portable-text-mimic-block.hbs" } });
});
;define("ember-share-db/templates/components/portable-text-span", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "eFMuFEOq", "block": "{\"symbols\":[\"child\"],\"statements\":[[4,\"each\",[[25,[\"children\"]]],null,{\"statements\":[[0,\"  \"],[7,\"span\"],[12,\"class\",[30,[[29,\"join\",[[24,1,[\"marks\"]],\" \"],null]]]],[9],[0,\"\\n\"],[4,\"if\",[[24,1,[\"isLink\"]]],null,{\"statements\":[[0,\"      \"],[7,\"a\"],[12,\"href\",[30,[[24,1,[\"href\"]]]]],[11,\"target\",\"_blank\"],[9],[1,[24,1,[\"text\"]],false],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[4,\"if\",[[24,1,[\"text\"]]],null,{\"statements\":[[0,\"        \"],[1,[24,1,[\"text\"]],false],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"        ‎\\n\"]],\"parameters\":[]}]],\"parameters\":[]}],[0,\"  \"],[10],[0,\"\\n\"]],\"parameters\":[1]},null]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/portable-text-span.hbs" } });
});
;define("ember-share-db/templates/components/project-generator", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "TXUWQNrn", "block": "{\"symbols\":[\"nav\",\"dd\",\"ddm\",\"output\",\"index\",\"nav\",\"dd\",\"ddm\",\"model\",\"index\",\"nav\",\"dd\",\"ddm\",\"input\",\"index\"],\"statements\":[[7,\"div\"],[11,\"id\",\"project-generator-container\"],[9],[0,\"\\n  \"],[7,\"p\"],[9],[0,\"\\n\\n  \"],[10],[0,\"\\n  \"],[7,\"table\"],[11,\"id\",\"project-generator-table\"],[9],[0,\"\\n    \"],[7,\"tr\"],[9],[0,\"\\n      \"],[7,\"td\"],[9],[0,\"\\n\"],[4,\"bs-nav\",null,[[\"class\"],[\"project-generator-ul\"]],{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,11,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/project-generator.hbs' @ L9:C9) \"],null]],null,{\"statements\":[[0,\"        \"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,12,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/project-generator.hbs' @ L10:C11) \"],null]],[[\"class\"],[\"nav-dropdown burger-btn\"]],{\"statements\":[[0,\" Input \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,12,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/project-generator.hbs' @ L11:C11) \"],null]],null,{\"statements\":[[4,\"each\",[[24,0,[\"inputLabels\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,13,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/project-generator.hbs' @ L13:C13) \"],null]],null,{\"statements\":[[0,\"            \"],[7,\"a\"],[11,\"class\",\"nav-button\"],[9],[1,[24,14,[]],false],[3,\"action\",[[24,0,[]],\"onInput\",[24,15,[]]]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[14,15]},null]],\"parameters\":[13]},null]],\"parameters\":[12]},null]],\"parameters\":[11]},null],[0,\"    \"],[10],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n\"],[4,\"bs-nav\",null,[[\"class\"],[\"project-generator-ul\"]],{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,6,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/project-generator.hbs' @ L23:C9) \"],null]],null,{\"statements\":[[0,\"        \"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,7,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/project-generator.hbs' @ L24:C11) \"],null]],[[\"class\"],[\"nav-dropdown burger-btn\"]],{\"statements\":[[0,\" Model \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,7,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/project-generator.hbs' @ L25:C11) \"],null]],null,{\"statements\":[[4,\"each\",[[24,0,[\"modelLabels\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,8,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/project-generator.hbs' @ L27:C13) \"],null]],null,{\"statements\":[[0,\"            \"],[7,\"a\"],[11,\"class\",\"nav-button\"],[9],[1,[24,9,[]],false],[3,\"action\",[[24,0,[]],\"onModel\",[24,10,[]]]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[9,10]},null]],\"parameters\":[8]},null]],\"parameters\":[7]},null]],\"parameters\":[6]},null],[0,\"    \"],[10],[0,\"\\n    \"],[7,\"td\"],[11,\"class\",\"project-generator-td\"],[9],[0,\"\\n\"],[4,\"bs-nav\",null,[[\"class\"],[\"project-generator-ul\"]],{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,1,[\"dropdown\"]],\"expected `nav.dropdown` to be a contextual component but found a string. Did you mean `(component nav.dropdown)`? ('ember-share-db/templates/components/project-generator.hbs' @ L37:C9) \"],null]],null,{\"statements\":[[0,\"        \"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,2,[\"toggle\"]],\"expected `dd.toggle` to be a contextual component but found a string. Did you mean `(component dd.toggle)`? ('ember-share-db/templates/components/project-generator.hbs' @ L38:C11) \"],null]],[[\"class\"],[\"nav-dropdown burger-btn\"]],{\"statements\":[[0,\" Output \"],[7,\"span\"],[11,\"class\",\"caret\"],[9],[10]],\"parameters\":[]},null],[0,\"\\n\"],[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,2,[\"menu\"]],\"expected `dd.menu` to be a contextual component but found a string. Did you mean `(component dd.menu)`? ('ember-share-db/templates/components/project-generator.hbs' @ L39:C11) \"],null]],null,{\"statements\":[[4,\"each\",[[24,0,[\"outputLabels\"]]],null,{\"statements\":[[4,\"component\",[[29,\"-assert-implicit-component-helper-argument\",[[24,3,[\"item\"]],\"expected `ddm.item` to be a contextual component but found a string. Did you mean `(component ddm.item)`? ('ember-share-db/templates/components/project-generator.hbs' @ L41:C13) \"],null]],null,{\"statements\":[[0,\"            \"],[7,\"a\"],[11,\"class\",\"nav-button\"],[9],[1,[24,4,[]],false],[3,\"action\",[[24,0,[]],\"onOutput\",[24,5,[]]]],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[4,5]},null]],\"parameters\":[3]},null]],\"parameters\":[2]},null]],\"parameters\":[1]},null],[0,\"    \"],[10],[0,\"\\n  \"],[10],[0,\"\\n\\n  \"],[7,\"tr\"],[9],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-title-label\"],[11,\"id\",\"selected-input-label\"],[9],[1,[23,\"selectedInputLabel\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-title-label\"],[11,\"id\",\"selected-model-label\"],[9],[1,[23,\"selectedModelLabel\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-title-label\"],[11,\"id\",\"selected-output-label\"],[9],[1,[23,\"selectedOutputLabel\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n  \"],[10],[0,\"\\n  \"],[7,\"tr\"],[9],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-description-label\"],[11,\"id\",\"selected-input-description-label\"],[9],[1,[23,\"selectedInputDescription\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-description-label\"],[11,\"id\",\"selected-model-description-label\"],[9],[1,[23,\"selectedModelDescription\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n    \"],[7,\"td\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"project-generator-description-label\"],[11,\"id\",\"selected-output-description-label\"],[9],[1,[23,\"selectedOutputDescription\"],false],[10],[0,\"\\n    \"],[10],[0,\"\\n  \"],[10],[0,\"\\n\"],[10],[0,\"\\n\"],[4,\"bs-button\",null,[[\"id\",\"onClick\"],[\"project-generator-submit-btn\",[29,\"action\",[[24,0,[]],\"submit\"],null]]],{\"statements\":[[0,\"  Make My ML Project\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"session\",\"isAuthenticated\"]]],null,{\"statements\":[[7,\"div\"],[9],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[7,\"p\"],[11,\"style\",\"text-align:center;width:100%;\"],[9],[0,\"Sign in to make a new project\"],[10],[0,\"\\n\"]],\"parameters\":[]}],[10],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/project-generator.hbs" } });
});
...
;define("ember-share-db/templates/components/video-embed", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "CRfllZ1h", "block": "{\"symbols\":[],\"statements\":[[4,\"if\",[[25,[\"videoId\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"class\",\"video-embed\"],[9],[0,\"\\n\"],[4,\"if\",[[25,[\"title\"]]],null,{\"statements\":[[0,\"      \"],[7,\"p\"],[11,\"class\",\"tutorial-heading video-embed-title\"],[9],[1,[23,\"title\"],false],[10],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"tutorial-video-embed\"],[9],[0,\"\\n      \"],[7,\"iframe\"],[12,\"src\",[30,[[23,\"embedSrcUrl\"]]]],[11,\"title\",\"video player\"],[11,\"frameborder\",\"0\"],[11,\"allow\",\"accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture; web-share\"],[11,\"allowfullscreen\",\"\"],[9],[10],[0,\"\\n    \"],[10],[0,\"\\n\\n\"],[4,\"if\",[[25,[\"text_contents\"]]],null,{\"statements\":[[0,\"      \"],[5,\"portable-text-contents\",[],[[\"@contents\"],[[23,\"text_contents\"]]]],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"  \"],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/components/video-embed.hbs" } });
});
;define("ember-share-db/templates/course", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "JTVZuvxY", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"class\",\"limited-width-container course-title\"],[9],[0,\"\\n  \"],[7,\"h1\"],[9],[4,\"link-to\",[\"course.course-overview\",[25,[\"model\"]]],null,{\"statements\":[[1,[25,[\"model\",\"title\"]],false]],\"parameters\":[]},null],[10],[0,\"\\n\"],[10],[0,\"\\n\\n\"],[7,\"div\"],[11,\"id\",\"tutorial-container\"],[11,\"class\",\"course-container\"],[9],[0,\"\\n  \"],[1,[23,\"outlet\"],false],[0,\"\\n\"],[10]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/course.hbs" } });
});
;define("ember-share-db/templates/course/course-overview", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "rQHfquCh", "block": "{\"symbols\":[\"unit\",\"index\"],\"statements\":[[7,\"h1\"],[9],[0,\"Course Overview\"],[10],[0,\"\\n\"],[7,\"h3\"],[11,\"class\",\"course-overview-description\"],[9],[1,[25,[\"model\",\"description\"]],false],[10],[0,\"\\n\"],[4,\"if\",[[25,[\"model\",\"poster-image\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"class\",\"course-overview-poster-image-container\"],[9],[0,\"\\n    \"],[7,\"img\"],[12,\"src\",[30,[[29,\"sanityImageUrlBuilder\",[[25,[\"model\",\"poster-image\"]],850,350],null]]]],[9],[10],[0,\"\\n  \"],[10],[0,\"\\n\"]],\"parameters\":[]},null],[5,\"portable-text-contents\",[],[[\"@contents\"],[[25,[\"model\",\"summary\"]]]]],[0,\"\\n\\n\"],[7,\"div\"],[11,\"class\",\"course-overview-prerequisites\"],[9],[0,\"\\n  \"],[7,\"h3\"],[9],[0,\"Prerequisites\"],[10],[0,\"\\n  \"],[5,\"portable-text-contents\",[],[[\"@contents\"],[[25,[\"model\",\"prerequisites\"]]]]],[0,\"\\n\"],[10],[0,\"\\n\\n\"],[7,\"hr\"],[11,\"class\",\"course-overview-hr\"],[9],[10],[0,\"\\n\\n\"],[7,\"div\"],[11,\"class\",\"course-overview-units-container\"],[9],[0,\"\\n  \"],[7,\"h1\"],[9],[0,\"Course Units\"],[10],[0,\"\\n\"],[4,\"each\",[[25,[\"model\",\"units\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[11,\"class\",\"course-overview-guide-tile-container\"],[9],[4,\"link-to\",[\"course.course-unit\",[24,1,[\"id\"]]],null,{\"statements\":[[1,[29,\"guide-tile\",null,[[\"guide\",\"index\"],[[24,1,[]],[24,2,[]]]]],false]],\"parameters\":[]},null],[10],[0,\"\\n\"]],\"parameters\":[1,2]},null],[10],[0,\"\\n\\n\"],[1,[23,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/course/course-overview.hbs" } });
});
;define("ember-share-db/templates/course/course-unit", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "EaNKEqTj", "block": "{\"symbols\":[],\"statements\":[[7,\"div\"],[11,\"class\",\"course-unit-container\"],[9],[0,\"\\n  \"],[5,\"collapsable-unit-list\",[],[[\"@units\",\"@currUnitId\"],[[25,[\"model\",\"course\",\"units\"]],[25,[\"model\",\"courseUnit\",\"id\"]]]]],[0,\"\\n\\n  \"],[7,\"div\"],[11,\"class\",\"course-unit-content-container\"],[9],[0,\"\\n\\n    \"],[7,\"div\"],[11,\"class\",\"course-unit-title-container\"],[9],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"tutorial-heading-big\"],[9],[0,\"\\n        \"],[1,[25,[\"model\",\"courseUnit\",\"title\"]],false],[0,\"\\n      \"],[10],[0,\"\\n\\n      \"],[7,\"h3\"],[9],[0,\"\\n        \"],[1,[25,[\"model\",\"courseUnit\",\"description\"]],false],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\\n\"],[0,\"    \"],[5,\"portable-text-contents\",[],[[\"@contents\"],[[25,[\"model\",\"courseUnit\",\"contents\"]]]]],[0,\"\\n\"],[0,\"  \"],[10],[0,\"\\n\"],[10],[0,\"\\n\\n\"],[7,\"div\"],[11,\"class\",\"course-unit-footer\"],[9],[0,\"\\n\"],[4,\"if\",[[25,[\"model\",\"prevUnit\",\"id\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onFooterLinkClick\"],null]],[11,\"class\",\"course-unit-footer-group\"],[9],[0,\"\\n      \"],[7,\"span\"],[9],[0,\"← Previous Unit\"],[10],[0,\"\\n      \"],[7,\"span\"],[9],[0,\"\\n\"],[4,\"link-to\",[\"course.course-unit\",[25,[\"model\",\"prevUnit\",\"id\"]]],null,{\"statements\":[[0,\"          \"],[1,[25,[\"model\",\"prevUnit\",\"title\"]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[7,\"div\"],[9],[10],[0,\"\\n\"]],\"parameters\":[]}],[4,\"if\",[[25,[\"model\",\"nextUnit\",\"id\"]]],null,{\"statements\":[[0,\"    \"],[7,\"div\"],[12,\"onclick\",[29,\"action\",[[24,0,[]],\"onFooterLinkClick\"],null]],[11,\"class\",\"course-unit-footer-group next\"],[9],[0,\"\\n      \"],[7,\"span\"],[9],[0,\"Next Unit →\"],[10],[0,\"\\n      \"],[7,\"span\"],[9],[0,\"\\n\"],[4,\"link-to\",[\"course.course-unit\",[25,[\"model\",\"nextUnit\",\"id\"]]],null,{\"statements\":[[0,\"          \"],[1,[25,[\"model\",\"nextUnit\",\"title\"]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"    \"],[7,\"div\"],[9],[10],[0,\"\\n\"]],\"parameters\":[]}],[10],[0,\"\\n\\n\"],[1,[23,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/course/course-unit.hbs" } });
});
;define("ember-share-db/templates/courses", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "mNDD4yYs", "block": "{\"symbols\":[\"group\",\"index\"],\"statements\":[[7,\"div\"],[11,\"id\",\"tutorial-container\"],[9],[0,\"\\n  \"],[7,\"h1\"],[9],[0,\"Courses\"],[10],[0,\"\\n\"],[4,\"each\",[[25,[\"model\"]]],null,{\"statements\":[[0,\"    \"],[7,\"h3\"],[9],[4,\"link-to\",[\"course.course-overview\",[24,1,[]]],[[\"class\"],[\"button\"]],{\"statements\":[[1,[24,1,[\"title\"]],false]],\"parameters\":[]},null],[10],[0,\"\\n\\n    \"],[7,\"p\"],[9],[1,[24,1,[\"description\"]],false],[10],[0,\"\\n\"]],\"parameters\":[1,2]},null],[0,\"  \"],[1,[23,\"outlet\"],false],[0,\"\\n\"],[10]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/courses.hbs" } });
});
...
;define("ember-share-db/templates/guides", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "MepCiIRI", "block": "{\"symbols\":[\"group\",\"index\",\"guide\",\"course\",\"index\"],\"statements\":[[4,\"if\",[[25,[\"isGuide\"]]],null,{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"id\",\"tutorial-container\"],[9],[0,\"\\n    \"],[7,\"h1\"],[9],[0,\" Guide to \"],[1,[25,[\"model\",\"name\"]],false],[0,\" \"],[10],[0,\"\\n\"],[4,\"if\",[[25,[\"isKadenze\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"kadenze-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isMaxim\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"maximillian-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isMMLL\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"mmll-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isRAPIDMIX\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"rapidlib-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isEvolib\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"evolib-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isLearner\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"learner-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isMaxiInstruments\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"maxiinstrument-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isRecording\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"recording-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isColab\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"colab-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[4,\"if\",[[25,[\"isSupervisedML\"]]],null,{\"statements\":[[0,\"      \"],[1,[23,\"supervised-ml-guide\"],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"  \"],[10],[0,\"\\n\"]],\"parameters\":[]},{\"statements\":[[0,\"  \"],[7,\"div\"],[11,\"id\",\"tutorial-container\"],[9],[0,\"\\n\\n    \"],[7,\"div\"],[11,\"class\",\"guides-section\"],[9],[0,\"\\n      \"],[7,\"h2\"],[9],[0,\"Courses\"],[10],[0,\"\\n      \"],[7,\"h3\"],[9],[0,\"Full courses on topics such as machine learning and creative coding\"],[10],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n        Each course will take you through several lesson units using the MIMIC\\n        library for interactive content\\n      \"],[10],[0,\"\\n\"],[0,\"      \"],[7,\"h1\"],[9],[10],[0,\"\\n\\n      \"],[7,\"div\"],[11,\"class\",\"row\"],[9],[0,\"\\n\\n\"],[4,\"each\",[[25,[\"sortedCourses\"]]],null,{\"statements\":[[4,\"if\",[[24,4,[\"is-published\"]]],null,{\"statements\":[[0,\"            \"],[7,\"div\"],[11,\"class\",\"course-overview-guide-tile-container\"],[9],[0,\"\\n\"],[4,\"link-to\",[\"course\",[24,4,[\"id\"]]],null,{\"statements\":[[0,\"                \"],[1,[29,\"guide-tile\",null,[[\"guide\",\"index\",\"author\"],[[24,4,[]],[24,5,[]],[29,\"getCourseAuthor\",[[24,4,[]]],null]]]],false],[0,\"\\n\"]],\"parameters\":[]},null],[0,\"            \"],[10],[0,\"\\n\"]],\"parameters\":[]},null]],\"parameters\":[4,5]},null],[0,\"\\n      \"],[10],[0,\"\\n    \"],[10],[0,\"\\n\\n    \"],[7,\"div\"],[11,\"class\",\"guides-section\"],[9],[0,\"\\n      \"],[7,\"h2\"],[9],[0,\"Guides\"],[10],[0,\"\\n      \"],[7,\"h3\"],[9],[0,\"Simple code examples of MIMIC libraries and ML concepts\"],[10],[0,\"\\n      \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n        Each guide below uses a MIMIC library to demonstrate how to use machine\\n        intelligence to make music in the browser\\n      \"],[10],[0,\"\\n\"],[4,\"each\",[[25,[\"model\",\"guides\"]]],null,{\"statements\":[[0,\"        \"],[7,\"h1\"],[9],[1,[24,1,[\"title\"]],false],[10],[0,\"\\n        \"],[7,\"div\"],[11,\"class\",\"row\"],[9],[0,\"\\n\"],[4,\"each\",[[24,1,[\"guides\"]]],null,{\"statements\":[[0,\"            \"],[1,[29,\"guide-tile\",null,[[\"onClick\",\"guide\",\"index\"],[[29,\"action\",[[24,0,[]],\"onClick\",[24,3,[]]],null],[24,3,[]],[24,2,[]]]]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"        \"],[10],[0,\"\\n\"]],\"parameters\":[1,2]},null],[0,\"    \"],[10],[0,\"\\n\\n  \"],[10],[0,\"\\n\"]],\"parameters\":[]}],[0,\"\\n\"],[1,[29,\"log\",[\"logging\"],null],false],[0,\"\\n\"],[1,[29,\"log\",[[25,[\"sortedCourses\"]]],null],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/guides.hbs" } });
});
...
;define("ember-share-db/templates/inputs", ["exports"], function (exports) {
  ...
  exports.default = Ember.HTMLBars.template({ "id": "xVD3lcyS", "block": "{\"symbols\":[\"category\",\"index\",\"example\"],\"statements\":[[0,\"\\n\\n\"],[7,\"div\"],[11,\"id\",\"example-container\"],[11,\"class\",\"row\"],[9],[0,\"\\n\\n  \"],[7,\"h2\"],[9],[0,\"Inputs\"],[10],[0,\"\\n\\n  \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n  When building your own interactive systems using machine learning, or a dataset for any purpose, you'll need get some inputs from the world.\\n  \"],[10],[0,\"\\n  \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n  Below we have a whole collection of Javascript example projects, showing you how to use feature extractors in the browser to build datasets and models using the Learner.js library. For information, \"],[7,\"a\"],[11,\"href\",\"https://mimicproject.com/guides/learner\"],[9],[0,\"check out this guide\"],[10],[0,\".\\n  \"],[10],[0,\"\\n\\n  \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n  You can try  using the \"],[7,\"strong\"],[9],[0,\"Project Generator\"],[10],[0,\" tool to generate a new project from scratch. Here, you get to select an input, a model type and an output. Or you can just check out some of the ready made examples underneath.\\n  \"],[10],[0,\"\\n\\n  \"],[7,\"h2\"],[9],[0,\"Project Generator (Beta)\"],[10],[0,\"\\n  \"],[7,\"p\"],[11,\"class\",\"tutorial-text\"],[9],[0,\"\\n\\n  \"],[10],[0,\"\\n  \"],[1,[29,\"project-generator\",null,[[\"onCreate\"],[[29,\"action\",[[24,0,[]],\"onCreate\"],null]]]],false],[0,\"\\n\\n  \"],[7,\"h2\"],[9],[0,\"Example Projects\"],[10],[0,\"\\n\\n\"],[4,\"each\",[[25,[\"examples\"]]],null,{\"statements\":[[0,\"    \"],[7,\"h1\"],[9],[1,[24,1,[\"title\"]],false],[10],[0,\"\\n    \"],[7,\"div\"],[11,\"class\",\"row\"],[9],[0,\"\\n\"],[4,\"each\",[[24,1,[\"docs\"]]],null,{\"statements\":[[0,\"      \"],[1,[29,\"example-tile\",null,[[\"onClick\",\"example\",\"index\"],[[29,\"action\",[[24,0,[]],\"onClick\",[24,3,[]]],null],[24,3,[]],[24,2,[]]]]],false],[0,\"\\n\"]],\"parameters\":[3]},null],[0,\"  \"],[10],[0,\"\\n\"]],\"parameters\":[1,2]},null],[10],[0,\"\\n\"]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/inputs.hbs" } });
});
...
;define("ember-share-db/templates/tfjs", ["exports"], function (exports) {
  "use strict";

  Object.defineProperty(exports, "__esModule", {
    value: true
  });
  exports.default = Ember.HTMLBars.template({ "id": "NzCcC5pb", "block": "{\"symbols\":[],\"statements\":[[1,[23,\"outlet\"],false]],\"hasEval\":false}", "meta": { "moduleName": "ember-share-db/templates/tfjs.hbs" } });
});
...
;
          if (!runningTests) {
            require("ember-share-db/app")["default"].create({"name":"ember-share-db","version":"0.0.0+63346ff8"});
          }
